...
epmSensorAddress_key = "epmSensor"
...
fpgaSensorInfo = \
    [["a0", "u42", "u42", "fpga heatsink"], ["a2", "u93", "u93", "q46"],
     ["a4", "u109", "u109", "q26"], ["a8", "u7", "u7", "q3"]]
...
## epmSensorAddress was parsed from a list
## for parseSpecs, include the list of possible
## label (address) values

epmTempSensorParseSpec = \
    [[pt.parseLineID, epmTempSensorLogSpec_key],
     [epmSensorAddress, pt.var_STRING],
      [pt.parseDatum, pt.var_FIXEDPOINT]]

## epmLocalAlerts are parsed from a list of keys
## include the list in the Parse Spec
localEpmAlertParseSpec = \
    [[pt.parseLineID, localEpmAlertLogSpec_key],
     [epmLocalAlerts, pt.var_STRING]]
...
## fanTachCountID is the list of labels for an INT variable
## entire list of alternatives is placed in lieu of
## pt.ParseXXXXfromList keywords.

fanSpeedParseSpec = \
    [[pt.parseLineID, fanSpeedLogSpec_key],
     ["fansocket", pt.var_STRING],
     [fanTachCountID, pt.var_INT],
     ["rpm", pt.var_INT]]
